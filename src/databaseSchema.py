...
for element in list_of_files:
    ...
    print("Successfully created Database {a}".format(element))
    ...
    mydatabase = mysql.connector.connect(host='localhost',
                                         ...
                                         user='root',
                                         password='...')
    print("Successfully connected to Database {a}".format(element))
    ...
    if element == "yld_data":
        ...
        for ele in datadir:
            ...
            print("Successfully created table {b} in Database {a}".format(a = element, b = ele.split('.')[0]))
            ...
            for _, row in df.iterrows():
                ...
                mydatabase.commit()
                print("Successfully inserted data into  table {b}".format(b=ele.split('.')[0]))

...
for wf in cursor:
    ...
    print("Get data from  table {b}".format(b=wf))
...
print("Successfully created table {b}".format(b=result))
...
print("Successfully inserted data into  table {b}".format(b=result))